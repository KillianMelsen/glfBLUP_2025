...
# Export results:
write.csv(results, sprintf("hyper/results/8%s_hyper_results_multiMLP_%sVEG.csv",
                           lab, CV))

list.save(histories, sprintf("hyper/results/8%s_hyper_results_multiMLP_%sVEG.RData",
                             lab, CV))
