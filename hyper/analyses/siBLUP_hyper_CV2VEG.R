...
for (CV in c("CV2")) {
  ...
  # Export results:
  write.csv(results, sprintf("hyper/results/5%s_hyper_results_siblup_%sVEG.csv", lab, CV))
  
  list.save(extra, sprintf("hyper/results/5%s_hyper_extra_results_siblup_%sVEG.RData", lab, CV))
