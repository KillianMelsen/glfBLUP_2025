...
load("genotypes/H_hyper_VEG.RData")
...
cl <- parallel::makeCluster(n.cores, outfile = "logs/phenomic_hyper_CV2VEG.txt")
...
# Export results:
write.csv(results, "hyper/results/0_hyper_results_phenomic_CV2VEG.csv")
