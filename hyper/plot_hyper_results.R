...
results[results$Model == "gfBLUP" & results$Scenario == "CV1", 4] <- read.csv(sprintf("hyper/results/%s/3a_hyper_results_gfblup_CV1.csv", prep))$acc
results[results$Model == "gfBLUP" & results$Scenario == "CV2", 4] <- read.csv(sprintf("hyper/results/%s/3b_hyper_results_gfblup_CV2.csv", prep))$acc
results[results$Model == "gfBLUP" & results$Scenario == "CV2VEG", 4] <- read.csv(sprintf("hyper/results/%s/3b_hyper_results_gfblup_CV2VEG.csv", prep))$acc
...
results[results$Model == "lsBLUP" & results$Scenario == "CV2VEG", 4] <- read.csv(sprintf("hyper/results/%s/11b_hyper_results_lsblup_CV2VEG.csv", prep))$acc

results[results$Model == "siBLUP" & results$Scenario == "CV1", 4] <- read.csv(sprintf("hyper/results/%s/5a_hyper_results_siblup_CV1.csv", prep))$acc
