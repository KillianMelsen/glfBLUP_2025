...
for (h2y in h2.foc) {
  for (h2s in h2.sec) {
    for (comm in comms) {
      ...
      # Export results:
      write.csv(results, sprintf("p800_V2/results/h2s%s/8%s_p800_V2_results_multiMLP_%s_h2y%s_comm%s_h2s%s_1to10.csv",
                                 h2s, lab, CV, h2y, comm, h2s))

      list.save(histories, sprintf("p800_V2/results/h2s%s/8%s_p800_V2_results_multiMLP_%s_h2y%s_comm%s_h2s%s_1to10.RData",
                                   h2s, lab, CV, h2y, comm, h2s))
