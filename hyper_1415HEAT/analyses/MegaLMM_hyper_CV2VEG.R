# This script produces all intermediate results for the MegaLMM CV2VEG analyses on
...
# Export results:
write.csv(results, sprintf("hyper_1415HEAT/results/%s/12%s_hyper_results_megalmm_%sVEG.csv", prep, lab, CV))
