...
#   are defined on lines 86 and 87.
...
#   heritability are produced in a final inner loop starting on line 98.
#
...
# lines 86 (comm) and 87 (h2y). Then we set `n.sim <- 27` instead of setting it to
# 100 on line 90. Then running the inner loop will produce the correct accuracy for
