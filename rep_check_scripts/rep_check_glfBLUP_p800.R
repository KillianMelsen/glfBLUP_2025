...
#   each worker are defined on lines 86 and 87.
...
#   heritability are produced in a final inner loop starting on line 104.
#
...
# lines 86 (comm) and 87 (h2s). Then we set `last <- 9` instead of setting it to
# 100 on line 91. Then running the inner loop will produce the correct CV1 and CV2
