...
#   of the third are defined on lines 79 and 80.
...
#   heritability are produced in a final inner loop starting on line 95.
#
...
# lines 79 (comm) and 80 (h2s). Then we set `last <- 59` instead of setting it to
# 100 on line 84. Then running the inner loop will produce the correct accuracy for
