...
ggsave("plots/MegaLMM_hyper_1415B5IR_single_date_M5.png", width = 24, height = 7.5, units = "cm")
...
ggsave("plots/MegaLMM_hyper_1415B5IR_single_date_M10.png", width = 24, height = 8.3, units = "cm")
...
ggsave(plot = p2, filename = "plots/MegaLMM_hyper_1415B5IR_single_date_traceplot_WL_M10_part2.png",
       width = 24, height = 31.3, units = "cm")
