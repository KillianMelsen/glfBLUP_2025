# This script produces Figure 4 of the manuscript main text. To reproduce the figure,
# make sure that the datafile loaded on line 24 is available.
...
ggsave("plots/main_text_figure_4.png", width = 24, height = 8, units = "cm")
