...
#
# Suppose you want to reproduce the result of replication 3 (CV1). First, manually
# set `CV <- "CV1"` and `lab <- "a"`. Looking at the `work` variable, replication 3 is handled by
