...
# part 5 scripts for the p800 MegaLMM analyses. It then deletes the non-merged
# csv files.
  ...
  for (h2s in h2.sec) {
    for (comm in comms) {
      for (h2y in h2.foc) {
        ...
        # Deleting part 1 - 5:
        unlink(sprintf("p800/results/h2s%s/12%s_p800_results_MegaLMM_%s_h2y%s_comm%s_h2s%s_1to4.csv",
                       h2s, lab, CV, h2y, comm, h2s))
        unlink(sprintf("p800/results/h2s%s/12%s_p800_results_MegaLMM_%s_h2y%s_comm%s_h2s%s_5to8.csv",
                       h2s, lab, CV, h2y, comm, h2s))
        unlink(sprintf("p800/results/h2s%s/12%s_p800_results_MegaLMM_%s_h2y%s_comm%s_h2s%s_9to12.csv",
                       h2s, lab, CV, h2y, comm, h2s))
        unlink(sprintf("p800/results/h2s%s/12%s_p800_results_MegaLMM_%s_h2y%s_comm%s_h2s%s_13to16.csv",
                       h2s, lab, CV, h2y, comm, h2s))
        unlink(sprintf("p800/results/h2s%s/12%s_p800_results_MegaLMM_%s_h2y%s_comm%s_h2s%s_17to20.csv",
                       h2s, lab, CV, h2y, comm, h2s))
