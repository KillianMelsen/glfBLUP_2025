...
for (h2y in h2.foc) {
  ...
  foreach::foreach(i = 1:nrow(par.combis), .packages = c("rlist", "tictoc")) %dopar% {
    ...
    # Export results:
    write.csv(CV1.results, sprintf("p800/results/h2s%s/3a_p800_results_gfblup_CV1_h2y%s_comm%s_h2s%s_1to50.csv", h2s, h2y, comm, h2s))
    write.csv(CV2.results, sprintf("p800/results/h2s%s/3b_p800_results_gfblup_CV2_h2y%s_comm%s_h2s%s_1to50.csv", h2s, h2y, comm, h2s))
    
    
    list.save(extra, file = sprintf("p800/results/h2s%s/3a_p800_extra_results_gfblup_CV1_h2y%s_comm%s_h2s%s_1to50.RData", h2s, h2y, comm, h2s))
    list.save(extra, file = sprintf("p800/results/h2s%s/3b_p800_extra_results_gfblup_CV2_h2y%s_comm%s_h2s%s_1to50.RData", h2s, h2y, comm, h2s))
