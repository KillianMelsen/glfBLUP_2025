# This script produces figure 2 and figure 5 of the manuscript main text.
...
ggsave(filename = "plots/main_text_figure_5.png", dpi = 640, width = 25, height = 27.5, units = "cm")
...
ggsave(filename = "plots/main_text_figure_2.png", dpi = 640, width = 25, height = 27.5, units = "cm")
