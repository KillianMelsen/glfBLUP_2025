...
# Loading data:
pseudoCRD.nosplines <- readRDS("hyper_1415DRIP/data_generation/pseudoCRD_nosplines.rds")
pseudoCRD.splines <- readRDS("hyper_1415DRIP/data_generation/pseudoCRD_splines.rds")
pseudoCRD.VEGsplines <- readRDS("hyper_1415DRIP/data_generation/pseudoCRD_VEGsplines.rds")
...
for (run in 1:n.datasets) {
  ...
  rlist::list.save(datalist.nosplines, file = sprintf("hyper_1415DRIP/datasets/nosplines/hyper_dataset_%d.RData", run))
  ...
  rlist::list.save(datalist.splines, file = sprintf("hyper_1415DRIP/datasets/splines/hyper_dataset_%d.RData", run))
