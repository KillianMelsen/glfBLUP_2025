...
# MegaLMM CV1 hyperspectral HEAT analyses.
#
...
# Export results:
write.csv(results, sprintf("MegaLMM_rep_check_scripts/hyper_1415HEAT/results/%s/12%s_hyper_results_megalmm_%s.csv", prep, lab, CV))
