...
# MegaLMM CV2VEG hyperspectral B5IR analyses.
#
...
# Export results:
write.csv(results, sprintf("MegaLMM_rep_check_scripts/hyper_1415B5IR/results/%s/12%s_hyper_results_megalmm_%sVEG.csv", prep, lab, CV))
